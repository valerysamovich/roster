<?php
// PHP Script 1.0 - viewusers.inc.php
...
$query  = "SELECT * FROM userstbl"; // Define the query
...
echo "<table style='margin:auto auto 20px auto; width:750px; height:auto; font-size:14px;'>
		<caption style='text-align:center; margin-bottom:5px; font-size:16px;'>Users</caption>
		<tr>
			<th style='padding:7px 0px; background-color:#CCC'>User ID</th>
			<th style='padding:7px 0px; background-color:#CCC'>Firstname</th>
			<th style='padding:7px 0px; background-color:#CCC'>Lastname</th>
			<th style='padding:7px 0px; background-color:#CCC'>Email</th>
			<th style='padding:7px 0px; background-color:#CCC'>Password</th>
		</tr>";
	
while($row = mysqli_fetch_array($result)){
echo "<tr>";
	echo "<td style='border:1px solid silver;text-align:center;padding:5px 0px;margin:2px;'>" . $row['userid'] . "</td>";
	...
	echo "<td style='border:1px solid silver;text-align:center;padding:5px 0px;margin:2px;'>" . $row['password'] . "</td>";
echo "</tr>";
}
echo "</table>";
